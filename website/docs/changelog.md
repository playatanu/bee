...
- **[`docs/PERFORMANCE.md`](performance.md)** - a measured account of where
...
- **`beegen`, a binding generator.** It reads C++ headers with libclang and
  ...
  documentation in [docs/BINDINGS.md](bindings.md).
...
- **`hive`, a package manager**, shipped alongside `bee`:
  ...
  directory on disk. Full documentation in [docs/HIVE.md](hive.md).
